...
router.post('/create/:surveyName', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req: any, res) => {
    try {
...
router.post('/move/:folderId/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
...
router.post('/disable/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
        const surveyId = req.params.surveyId;
...
router.post('/enable/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
        const surveyId = req.params.surveyId;
...
router.post('/delete/:surveyId', roleMiddleware('ADMIN', 'OWNER'), async (req, res) => {
    try {
        const surveyId = req.params.surveyId;
...
router.post('/save/flow/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
...
router.get('/save/check/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
        const surveyId = req.params.surveyId;
...
router.post('/save/design/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
        const reqBody = req.body;
        const surveyId = req.params.surveyId;
...
router.post('/config/update/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
        const reqBody = req.body;
        const surveyId = req.params.surveyId;
...
router.get('/config/detail/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
        const surveyId = req.params.surveyId;
...
router.post('/update/name/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
        const surveyId = req.params.surveyId;
...
router.post('/duplicate/:surveyId', roleMiddleware('ADMIN', 'OWNER', 'USER'), async (req, res) => {
    try {
