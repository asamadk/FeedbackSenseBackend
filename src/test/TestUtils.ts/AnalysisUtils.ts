...
export const populateSurveyResponse = async (connection: any): Promise<string> => {
  ...
  surveyResponse.response = '[{"id":1,"uiId" : "dndnode_363","data":{"click":"next"},"compData":{"welcomeText":"Welcome to FeedbackSense","buttonText":"Next"}},{"id":6,"uiId" : "dndnode_4383","data":{"emojiId":"4"},"compData":{"question":"How are you feeling right now ?","leftText":"Very Bad","rightText":"Good"}},{"id":3,"uiId" : "dndnode_52","data":{"type":"single","selectedVal":"Yes"},"compData":{"question":"You know you","answerList":["Yes","No"],"type":"single"}}]';
  ...
  surveyResponse2.response = '[{"id":1,"uiId" : "dndnode_363","data":{"click":"next"},"compData":{"welcomeText":"Welcome to FeedbackSense","buttonText":"Next"}},{"id":6,"uiId" : "dndnode_4383","data":{"emojiId":"1"},"compData":{"question":"How are you feeling right now ?","leftText":"Very Bad","rightText":"Good"}},{"id":3,"uiId" : "dndnode_52","data":{"type":"single","selectedVal":"Yes"},"compData":{"question":"You know you","answerList":["Yes","No"],"type":"single"}}]';
